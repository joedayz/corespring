...
<head>
	...
	<title>dwr-1-solution: Edit Account Details</title>
</head>
...
<form:form commandName="account">
	<table>
		<tr>
			<td>Number:</td>
			<td><form:input path="number" maxlength="9"/></td>
		...
		<tr>
			...
			<td colspan="3"><input type="button" value="Cancel" 
						onclick="location.href='<c:url value="/accounts/accountSummary.htm"/>'"/></td>
		</tr>
	</table>
</form:form>
