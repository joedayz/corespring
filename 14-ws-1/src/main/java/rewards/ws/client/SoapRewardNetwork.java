...
public class SoapRewardNetwork extends WebServiceGatewaySupport implements RewardNetwork {
	...
	public RewardConfirmation rewardAccountFor(Dining dining) {
		...
		// TODO 6: Use the webServiceTemplate to send and receive a message (getWebServiceTemplate())
	...
	private Element mapDining(Document document, Dining dining) {
		...
		// TODO 5: Populate the attributes of the dining element using the values from dining
